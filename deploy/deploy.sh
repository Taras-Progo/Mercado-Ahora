...
MERCADO_PAGO_WEBHOOK_URL=${MERCADO_PAGO_WEBHOOK_URL:-${APP_URL:-http://187.127.254.101}/api/v1/payments/webhooks/mercado-pago}
...
for mercado_pago_key in MERCADO_PAGO_MODE MERCADO_PAGO_PUBLIC_KEY MERCADO_PAGO_ACCESS_TOKEN MERCADO_PAGO_API_URL MERCADO_PAGO_TIMEOUT MERCADO_PAGO_RESERVATION_MINUTES MERCADO_PAGO_SUCCESS_URL MERCADO_PAGO_PENDING_URL MERCADO_PAGO_FAILURE_URL MERCADO_PAGO_WEBHOOK_URL; do
