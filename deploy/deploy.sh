...
MERCADO_PAGO_MODE=${MERCADO_PAGO_MODE:-sandbox}
MERCADO_PAGO_PUBLIC_KEY=${MERCADO_PAGO_PUBLIC_KEY:-}
MERCADO_PAGO_ACCESS_TOKEN=${MERCADO_PAGO_ACCESS_TOKEN:-}
MERCADO_PAGO_API_URL=${MERCADO_PAGO_API_URL:-https://api.mercadopago.com}
MERCADO_PAGO_TIMEOUT=${MERCADO_PAGO_TIMEOUT:-15}
MERCADO_PAGO_RESERVATION_MINUTES=${MERCADO_PAGO_RESERVATION_MINUTES:-30}
MERCADO_PAGO_SUCCESS_URL=${MERCADO_PAGO_SUCCESS_URL:-${FRONTEND_URL:-http://187.127.254.101}/checkout/pago/aprobado}
MERCADO_PAGO_PENDING_URL=${MERCADO_PAGO_PENDING_URL:-${FRONTEND_URL:-http://187.127.254.101}/checkout/pago/pendiente}
MERCADO_PAGO_FAILURE_URL=${MERCADO_PAGO_FAILURE_URL:-${FRONTEND_URL:-http://187.127.254.101}/checkout/pago/fallido}
MERCADO_PAGO_WEBHOOK_URL=${MERCADO_PAGO_WEBHOOK_URL:-${APP_URL:-http://187.127.254.101}/api/v1/payments/webhooks/mercado_pago}
MERCADO_PAGO_WEBHOOK_SECRET=${MERCADO_PAGO_WEBHOOK_SECRET:-}
MERCADO_PAGO_WEBHOOK_TOLERANCE_SECONDS=${MERCADO_PAGO_WEBHOOK_TOLERANCE_SECONDS:-300}
...
for mercado_pago_key in MERCADO_PAGO_MODE MERCADO_PAGO_PUBLIC_KEY MERCADO_PAGO_ACCESS_TOKEN MERCADO_PAGO_API_URL MERCADO_PAGO_TIMEOUT MERCADO_PAGO_RESERVATION_MINUTES MERCADO_PAGO_SUCCESS_URL MERCADO_PAGO_PENDING_URL MERCADO_PAGO_FAILURE_URL MERCADO_PAGO_WEBHOOK_URL MERCADO_PAGO_WEBHOOK_SECRET MERCADO_PAGO_WEBHOOK_TOLERANCE_SECONDS; do
    mercado_pago_value="${!mercado_pago_key:-}"
    if [ -n "$mercado_pago_value" ]; then
        set_env_value "$mercado_pago_key" "$mercado_pago_value"
    fi
done
