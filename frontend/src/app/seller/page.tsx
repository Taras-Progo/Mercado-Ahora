      ...
      <main className="mx-auto grid max-w-5xl gap-5 px-4 py-8 sm:px-6">
        <div className="flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="flex gap-2">
            <Link href="/seller/apply" className="rounded-md border border-emerald-800 px-3 py-2 text-sm font-semibold text-emerald-900">Postulación</Link>
        ...
        <ApiPanel title="Dashboard" endpoint="/seller/dashboard" emptyText="Ingresá como vendedor para ver el panel." />
      </main>
    </>
  );
}
