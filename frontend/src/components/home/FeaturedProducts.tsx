...
const featured: FeaturedProduct[] = [
  {
    ...
    description: "Hecha a mano en gres",
    price: "$4.500",
  ...
  },
  {
    ...
    description: "Algodón natural orgánico",
    price: "$6.800",
  ...
  {
    name: "Miel multifloral pura",
    description: "Producción agroecológica",
    price: "$4.200",
  ...
  {
    name: "Tabla de madera de algarrobo",
    description: "Madera nativa local",
    price: "$22.000",
...
function ProductCard({ product }: { product: FeaturedProduct }) {
  return (
    <article className="group overflow-hidden rounded-2xl border border-border-soft bg-white transition hover:shadow-lg">
